...
function horizontal_cut_transform(direction)  {
    switch (direction) {
        case NoteCutDirection.UpLeft: return NoteCutDirection.UpRight;
        case NoteCutDirection.DownLeft: return NoteCutDirection.DownRight;
        case NoteCutDirection.UpRight: return NoteCutDirection.UpLeft;
        case NoteCutDirection.DownRight: return NoteCutDirection.DownLeft;
...
function vertical_cut_transform(direction)  {
    switch (direction) {
        ...
        case NoteCutDirection.UpLeft: return NoteCutDirection.DownLeft;
        case NoteCutDirection.DownLeft: return NoteCutDirection.UpLeft;
        case NoteCutDirection.UpRight: return NoteCutDirection.DownRight;
        case NoteCutDirection.DownRight: return NoteCutDirection.UpRight;
        default:
        break;
    }
